...
module.exports.execute = async (client, message, args, ayar, emoji) => {
  let embed = new MessageEmbed().setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true})).setFooter("Developer ❤️ Kai").setColor(client.randomColor()).setTimestamp();
  ...
  if(uye.manageable) uye.setNickname('୪ İsim | Yaş').catch();
